...
constexpr HostLoc ABI_FLOAT_RETURN = HostLoc::XMM0;
constexpr HostLoc ABI_FLOAT_RETURN2 = HostLoc::XMM1;
...
constexpr size_t ABI_FLOAT_PARAM_COUNT = 8;

constexpr HostLoc ABI_FLOAT_PARAM1 = HostLoc::XMM0;
constexpr HostLoc ABI_FLOAT_PARAM2 = HostLoc::XMM1;
constexpr HostLoc ABI_FLOAT_PARAM3 = HostLoc::XMM2;
constexpr HostLoc ABI_FLOAT_PARAM4 = HostLoc::XMM3;
constexpr HostLoc ABI_FLOAT_PARAM5 = HostLoc::XMM4;
constexpr HostLoc ABI_FLOAT_PARAM6 = HostLoc::XMM5;
constexpr HostLoc ABI_FLOAT_PARAM7 = HostLoc::XMM6;
constexpr HostLoc ABI_FLOAT_PARAM8 = HostLoc::XMM7;
