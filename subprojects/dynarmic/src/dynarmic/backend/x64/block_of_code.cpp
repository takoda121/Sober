...
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_RETURN = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_RETURN);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_RETURN2 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_RETURN2);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM1 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM1);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM2 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM2);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM3 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM3);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM4 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM4);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM5 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM5);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM6 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM6);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM7 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM7);
const Xbyak::Xmm BlockOfCode::ABI_FLOAT_PARAM8 = HostLocToXmm(Dynarmic::Backend::X64::ABI_FLOAT_PARAM8);
...
const std::array<Xbyak::Xmm, ABI_FLOAT_PARAM_COUNT> BlockOfCode::ABI_FLOAT_PARAMS = {
    BlockOfCode::ABI_FLOAT_PARAM1,
    BlockOfCode::ABI_FLOAT_PARAM2,
    BlockOfCode::ABI_FLOAT_PARAM3,
    BlockOfCode::ABI_FLOAT_PARAM4,
    BlockOfCode::ABI_FLOAT_PARAM5,
    BlockOfCode::ABI_FLOAT_PARAM6,
    BlockOfCode::ABI_FLOAT_PARAM7,
    BlockOfCode::ABI_FLOAT_PARAM8,
};
