...
public:
    ...
    static const Xbyak::Xmm ABI_FLOAT_RETURN;
    static const Xbyak::Xmm ABI_FLOAT_RETURN2;
    static const Xbyak::Reg64 ABI_PARAM1;
    static const Xbyak::Reg64 ABI_PARAM2;
    static const Xbyak::Reg64 ABI_PARAM3;
    static const Xbyak::Reg64 ABI_PARAM4;
    ...
    static const Xbyak::Xmm ABI_FLOAT_PARAM1;
    static const Xbyak::Xmm ABI_FLOAT_PARAM2;
    static const Xbyak::Xmm ABI_FLOAT_PARAM3;
    static const Xbyak::Xmm ABI_FLOAT_PARAM4;
    static const Xbyak::Xmm ABI_FLOAT_PARAM5;
    static const Xbyak::Xmm ABI_FLOAT_PARAM6;
    static const Xbyak::Xmm ABI_FLOAT_PARAM7;
    static const Xbyak::Xmm ABI_FLOAT_PARAM8;
    static const std::array<Xbyak::Reg64, ABI_PARAM_COUNT> ABI_PARAMS;
    static const std::array<Xbyak::Xmm, ABI_FLOAT_PARAM_COUNT> ABI_FLOAT_PARAMS;
#endif
