    ...
    namespace detail {
        ...
        struct arg_rewriter_impl<Arg, Args...> {
            ...
            static auto rewrite(Invoke const &invoke, RArgs... rargs, typename arg_rewrite<Arg>::source arg, typename arg_rewrite<Args>::source... args) {
                ...
                return arg_rewriter_impl<Args...>::template rewrite<Invoke, RArgs..., __typeof__(value)>(invoke, rargs..., value, args...);
            }
        };
        template <>
        struct arg_rewriter_impl<> {
...
#define AutoArgRewritten(ptr) (&shim::detail::arg_rewrite_helper<__typeof__(ptr)>::rewrite<ptr>)